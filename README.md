...
<h1 align='center'>
<b>Distribucion del Tamaño de las Propiedades En Colombia 🏠</b>
</h1>
...
En este proyecto, llevé a cabo una serie de procesos necesarios para abordar el problema de predecir la distribución de tamaños de propiedades. El proyecto se desarrolló en varias etapas 
Proceso de ETL (Extracción, Transformación, Carga)En esta etapa, se realizaron las siguientes actividades: Extracción de datos de diversas fuentes.
Transformación de los datos para limpiarlos y prepararlos.
Análisis Exploratorio de Datos (EDA) se llevó a cabo un análisis exhaustivo de los datos recopilados. Algunos de los aspectos destacados del EDA incluyeron:


- 👁️ Visualización de los datos para comprender su distribución.
- 📊Identificación de patrones en los datos.
- 🟰Detección de valores atípicos y su posible impacto.
- 💡Generación de ideas y preguntas relevantes para el problema en cuestión.
El EDA proporcionó una comprensión sólida de los datos antes de proceder con el desarrollo del modelo.

***
Desarrollo del Modelo de Machine Learning
En esta etapa, se llevaron a cabo varias tareas relacionadas con el desarrollo del modelo:

- 📶 Se creó un Baseline Model como punto de referencia inicial.
- 📊 Se exploraron algoritmos de Aprendizaje Automático adecuados para el problema.
- 📶 Se realizaron ajustes de hiperparámetros y validación cruzada.
- 📊 Se evaluó el rendimiento del modelo utilizando diversas métricas de regresión, como el Error Absoluto Medio (MAE), el Error Cuadrado Medio (MSE) y otros.
- 📶 El proceso de desarrollo del modelo se centró en construir un modelo preciso y generalizable para predecir la distribución de tamaños de propiedades.
...
Se desarrollaron modelos de Machine Learning, incluido un Baseline Model, y se evaluaron utilizando métricas de regresión. Para futuras iteraciones del proyecto, se pueden considerar las siguientes mejoras:

Explorar técnicas avanzadas de feature engineering para mejorar la calidad de las características.
Evaluar modelos más complejos y realizar una búsqueda exhaustiva de hiperparámetros.
Implementar un flujo de trabajo de actualización automática del modelo a medida que llegan nuevos datos.
...
## Contacto: 💬
[<img src="https://github.com/vimalverma558/vimalverma558/blob/v2/img/icons8-linkedin.svg" width="30px">](https://www.linkedin.com/in/natalia-aponte-murillo-2443b1266/)
[<img src="https://github.com/vimalverma558/vimalverma558/blob/v2/img/icons8-important-mail.svg" width="30px">](mailto:sweetnataly34@gmail.com)
